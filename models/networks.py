...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal',
    ...
    if netG == 'resnet_9blocks':
        ...
        net = ResnetGeneratorNICE(
            input_nc, output_nc, ngf, n_blocks=6, img_size=256, light=False)
...
def define_D(input_nc, ndf, netD, n_layers_D=3, norm='batch', init_type='normal', init_gain=0.02, no_antialias=False, gpu_ids=[], opt=None):
    ...
    elif netD == 'NICE':  # more options
        net = DiscriminatorNICE(input_nc, ndf, n_layers=7)
...
class ResnetGeneratorNICE(nn.Module):
    # ! no downsampling in there -> no encoder -> where does the encoder connect with that?
    def __init__(self, input_nc, output_nc, ngf=64, n_blocks=6, img_size=256, light=False):
        assert (n_blocks >= 0)
        super(ResnetGeneratorNICE, self).__init__()
