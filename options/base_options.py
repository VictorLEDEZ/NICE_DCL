...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='dcl',
        ...
        parser.add_argument('--netD', type=str, default='basic', choices=['basic', 'n_layers', 'NICE', 'pixel', 'patch', 'tilestylegan2', 'stylegan2'],
        ...
        parser.add_argument('--netG', type=str, default='resnet_9blocks', choices=[
                            'resnet_9blocks', 'resnet_6blocks', 'NICE', 'unet_256', 'unet_128', 'stylegan2', 'smallstylegan2', 'resnet_cat'], help='specify generator architecture')
